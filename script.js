...
function clickheart1(e) {
  if(e.target == heart1) {
    ...
    text1.innerHTML = 'You treat me like no other';
...
function clickheart2(e) {
  if(e.target == heart2) {
    ...
    text2.innerHTML = 'You support me at everything.';
    setTimeout(function touchHere() {
...
function clickheart3(e) {
  if(e.target == heart3) {
    ...
    text3.innerHTML = 'You make me a better person.';
    setTimeout(function touchHere() {
...
function clickheart4(e) {
  if(e.target == heart4) {
    ...
    text4.innerHTML = 'You make me feel warm.';
    setTimeout(function touchHere() {
...
function clickheart5(e) {
  if(e.target == heart5) {
    ...
    text5.innerHTML = 'When Im with you I feel home.';
    setTimeout(function touchHere() {
